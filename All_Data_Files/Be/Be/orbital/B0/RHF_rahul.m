...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Be/orbital/B0/orb_1_RHF_Bx_0.png','png');
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Be/orbital/B0/orb_2_RHF_Bx_0.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
%saveas(gcf,'/home/rahul/Documents/sample/Be/orbital/B0/orb_3_RHF_Bx_0.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
%saveas(gcf,'/home/rahul/Documents/sample/Be/orbital/B0/orb_4_RHF_Bx_0.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
%saveas(gcf,'/home/rahul/Documents/sample/Be/orbital/B0/orb_5_RHF_Bx_0.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Be/orbital/B0/orb_6_RHF_Bx_0.png','png')
