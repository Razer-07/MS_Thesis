...
DATA = load('plotxyBx_RHF_1.csv_orb');
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Orital/orb_1_RHF_Bx_1.png','png');
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Orital/orb_2_RHF_Bx_1.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Orital/orb_3_RHF_Bx_1.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Orital/orb_4_RHF_Bx_1.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Orital/orb_5_RHF_Bx_1.png','png')
...
plot(MOLECULE(:,1),MOLECULE(:,2),'kx','MarkerSize',20);
shading interp
saveas(gcf,'/home/rahul/Documents/sample/Orital/orb_6_RHF_Bx_1.png','png')
